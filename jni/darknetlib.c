...
#ifndef LOGI
	#define LOGI(...) ((void)__android_log_print( ANDROID_LOG_INFO, "bcv-dsp", __VA_ARGS__))
#endif
#ifndef LOGW
	#define LOGW(...) ((void)__android_log_print( ANDROID_LOG_WARN, "bcv-dsp", __VA_ARGS__))
#endif
#ifndef LOGD
	#define LOGD(...) ((void)__android_log_print(ANDROID_LOG_DEBUG, "bcv-dsp", __VA_ARGS__))
#endif

#ifndef LOGE
	#define LOGE(...) ((void)__android_log_print(ANDROID_LOG_ERROR, "bcv-dsp", __VA_ARGS__))
#endif
